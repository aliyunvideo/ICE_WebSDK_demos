<template>
   <div ref="containerRef" :style="{width: '800px', height: '450px', margin: '30px auto', background: '#efefef'}" ></div>
   <div   :style="{width: '800px',   margin: '30px auto', }" >
    <a-input v-model:value="projectIdRef" ></a-input>
    <a-button @click="reset" >重建</a-button>
  </div>
